...
class PlayerDetailPageWriter:
    ...
    def write_player_detail_pages(self, group_frames: dict[str, pd.DataFrame]) -> dict[str, dict[str, str]]:
        hitter_fields = [
            ...
            ("Regressed Offense", "offense_score_regressed", "0.52 overall / 0.58 projection"),
            ("Current Ratings (Centered)", "ratings_hitter_now_component", "(rating-50)/5; 0.22 overall / 0.27 projection"),
            ("Future Ratings (Centered)", "ratings_hitter_future_component", "(rating-50)/5; 0.48 projection"),
            ...
            ("Scarcity Bonus", "scarcity_bonus", "0.40 overall / 0.35 projection"),
        ...
        pitcher_fields = [
            ...
            ("Regressed Results", "results_pitcher_score_regressed", "0.58 score / 0.50 projection"),
            ("Current Ratings (Centered)", "ratings_pitcher_now_component", "(rating-50)/5; 0.30 score / 0.22 projection"),
            ("Future Ratings (Centered)", "ratings_pitcher_future_component", "(rating-50)/5; 0.24 projection"),
            ("Command Component", "command_dominance_component", "0.20 score / 0.20 projection"),
            ...
            ("Age Bonus", "age_bonus", "0.30 projection"),

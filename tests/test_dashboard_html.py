...
class DashboardHtmlTests(unittest.TestCase):
    ...
    def test_build_html_shell_includes_nav_date_and_active_page(self) -> None:
        ...
        self.assertIn("../src/images/detroit-logo.png", html)
        self.assertIn("../src/images/toledo-logo.png", html)
        self.assertIn('alt="Detroit Tigers logo"', html)
        self.assertIn('alt="Toledo Mud Hens logo"', html)
        self.assertIn("Detroit Tigers", html)
        self.assertIn("8-4", html)
        self.assertIn("1st", html)
        self.assertIn("<small>GB</small>", html)
        self.assertIn("<strong>0</strong>", html)
        self.assertIn("Toledo Mud Hens", html)
        self.assertIn("6-5", html)
        self.assertIn("2nd", html)
        self.assertIn("<strong>1.5</strong>", html)
